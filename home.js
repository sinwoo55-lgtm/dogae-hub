(function(){
  ...
  function lineClass(p,key,dow){var s=start(p),e=end(p);if(s===e)return 'line-single';var classes=[];if(key===s||dow===0)classes.push('line-start');if(key===e||dow===6)classes.push('line-end');return classes.join(' ')}
