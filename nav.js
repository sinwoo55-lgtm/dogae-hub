(function(){
  function init(){
    ...
    var pageInfo={
      ...
      'seating.html':{ko:'도개중고등학교 자리 배치표',en:'SEATING CHART'},
    ...
    var shade=document.createElement('div');shade.className='hub-nav-shade';var nav=document.createElement('aside');nav.className='hub-nav';nav.innerHTML='<div class="hub-nav-head">메뉴 <button class="hub-nav-close">×</button></div><a href="index.html">📅&nbsp; 캘린더</a><a href="links.html">🔗&nbsp; 링크 모음</a><a href="mindmap.html">🗂️&nbsp; 업무분장</a><a href="career.html">🌱&nbsp; 진로 활동 탐색기</a><a href="seating.html">🪑&nbsp; 자리 배치표</a><a href="forms.html">📄&nbsp; 양식 자료실</a>';document.body.append(shade,nav);
